...
`}
          ...
          <div className="mt-6 rounded bg-white p-6 shadow-md">
            <h2 className="mb-4 text-xl font-semibold">
            ...
            <ul className="list-disc pl-6">
              <li>
                <strong>
                  {!isHindi ? `Enabling Medical Assistance:` : `चिकित्सा सहायता सक्षम करना:`}
                </strong>
                {!isHindi
              ...
              <li>
                <strong>{!isHindi ? `Empowering Education:` : `शिक्षा को सशक्त बनाना:`}</strong>
                {!isHindi
              ...
              <li>
                <strong>{!isHindi ? `Fueling Skill Development:` : `कौशल विकास को बढ़ावा`}</strong>
                {!isHindi
